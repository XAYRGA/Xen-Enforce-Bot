...
#CONFIG
config/success|Modification réussie! {0} to {1}
config/dontUnderstandNumber|Je ne comprend pas la valeur! {0}, doit être un nombre.
config/somethingWrong|Pour une raison quelconque, je n’ai pas pu enregistrer la configuration. Contactez mon développeur.
config/featureDisabled|Fonctionnalité '{0}' désactivé avec succès .
config/featureEnabled|Fonctionnalité '{0}' activé succès.
...
feature/kickNoIcons/userKicked|{0} a été retiré du chat car ils n’ont pas d’icônes et «kicknoicons» est activé.
...
#AUTOREM 
autorem/removedBecauseBot|{0} a été retiré du groupe parce qu’ils ressemblent à un bot.
autorem/sorry|Hey %s, désolé de vous avoir kicker du groupe. Votre profil ressemble beaucoup à un bot, et je ne pouvais prendre aucun risque. Essayez ce qui suit :\n1. Ajouter des icônes de profil supplémentaires\n2. Ajouter un @NomDutilisateur à votre profil si vous n’en avez pas.\n3. Rallongez votre Nom D'utilisateur.
