...
namespace XenfbotDN
{
    ...
    public class TGChat
    {
        ...
        public async Task<TGMessage> sendMessage(string text)
        {
            return await Telegram.sendMessage(this, text);
        }
        public async Task<TGMessage> sendMessage(string text, string markdown)
        {
            return await Telegram.sendMessage(this, text, markdown);
        }
    }
    ...
    public class TGMessage
    {
        ...
        public async Task<TGMessage> replySendMessage(string text)
        {
            if (this.chat != null)
            {
                return await Telegram.sendMessage(this.chat, text);
            }
            else
            {
        ...
        public async Task<bool> delete()
        {
            if (this.chat != null)
            {
                return await Telegram.deleteMessage(chat, this);
            }
            else
            {
        ...
        public async Task<bool> isSenderAdmin()
        {
            var ChatMem = await Telegram.getChatMember(chat, from);
